...
class RegistrosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nombre' => ['type' => 'string', 'length' => 40, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'pasos' => 1,
            'fecha' => '2016-11-09',
            'create' => '2016-11-09 18:32:54',
            'modified' => '2016-11-09 18:32:54'
        ],
    ];
}
